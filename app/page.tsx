            ...
            <div className="grid gap-6 sm:gap-8 lg:grid-cols-2">
              {[
                ...
                <a
                  key={index}
                  href={project.link}
                  className="group p-6 sm:p-8 border border-border rounded-lg hover:border-muted-foreground/50 transition-all duration-500 hover:shadow-lg hover:bg-muted/30 cursor-pointer"
                >
                  <div className="space-y-4">
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-2 text-muted-foreground">
              <p className="text-sm">
                Design inspired by © 2025 Felix Macaspac. All rights reserved.
              </p>
            </div>
